...
# Cricket
mwoffliner --verbose --mwUrl="https://en.wikipedia.org/" --adminEmail=kelson@kiwix.org --customZimFavicon="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c2/Cricketball.svg/488px-Cricketball.svg.png" --customZimTitle="Cricket by Wikipedia" --customZimDescription="Wikipedia articles dedicated to Cricket" --articleList=https://download.kiwix.org/wp1/enwiki/projects/Cricket --format=novid --format=nopic
