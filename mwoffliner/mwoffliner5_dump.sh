...
# Football
# MIGRATED mwoffliner --verbose --mwUrl="https://en.wikipedia.org/" --adminEmail=kelson@kiwix.org --customZimFavicon="https://upload.wikimedia.org/wikipedia/en/thumb/e/ec/Soccer_ball.svg/900px-Soccer_ball.svg.png" --customZimTitle="Football by Wikipedia" --customZimDescription="Wikipedia articles dedicated to Football" --articleList=https://download.kiwix.org/wp1/enwiki/projects/Football --withZimFullTextIndex  --format=novid --format=nopic

# Basketball
# MIGRATED mwoffliner --verbose --mwUrl="https://en.wikipedia.org/" --adminEmail=kelson@kiwix.org --customZimFavicon="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/Basketball.svg/180px-Basketball.svg.png" --customZimTitle="Basketball by Wikipedia" --customZimDescription="Wikipedia articles dedicated to Basketball" --articleList=https://download.kiwix.org/wp1/enwiki/projects/Basketball --withZimFullTextIndex --format=novid --format=nopic

# History
# MIGRATED mwoffliner --verbose --mwUrl="https://en.wikipedia.org/" --adminEmail=kelson@kiwix.org --customZimFavicon="https://upload.wikimedia.org/wikipedia/commons/a/af/P_history.png" --customZimTitle="History by Wikipedia" --customZimDescription="Wikipedia articles dedicated to History" --articleList=https://download.kiwix.org/wp1/enwiki/projects/History --withZimFullTextIndex --format=nopic --format=novid

# Geography
# MIGRATED mwoffliner --verbose --mwUrl="https://en.wikipedia.org/" --adminEmail=kelson@kiwix.org --customZimFavicon="https://upload.wikimedia.org/wikipedia/commons/thumb/f/fa/Globe.svg/900px-Globe.svg.png" --customZimTitle="Geography by Wikipedia" --customZimDescription="Wikipedia articles dedicated to Geography" --articleList=https://download.kiwix.org/wp1/enwiki/projects/Geography --format=novid --format=nopic

# Comics
# MIGRATED mwoffliner --verbose --mwUrl="https://en.wikipedia.org/" --adminEmail=kelson@kiwix.org --customZimFavicon="https://upload.wikimedia.org/wikipedia/commons/thumb/3/37/Speech_balloon.svg/788px-Speech_balloon.svg.png" --customZimTitle="Comics by Wikipedia" --customZimDescription="Wikipedia articles dedicated to Comics" --articleList=https://download.kiwix.org/wp1/enwiki/projects/Comics --format=novid --format=nopic

# Cricket
# MIGRATED mwoffliner --verbose --mwUrl="https://en.wikipedia.org/" --adminEmail=kelson@kiwix.org --customZimFavicon="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c2/Cricketball.svg/488px-Cricketball.svg.png" --customZimTitle="Cricket by Wikipedia" --customZimDescription="Wikipedia articles dedicated to Cricket" --articleList=https://download.kiwix.org/wp1/enwiki/projects/Cricket --format=novid --format=nopic

# Computer
# wget "https://upload.wikimedia.org/wikipedia/commons/8/8a/Gnome-system.png" -O "$SCRIPT_DIR/computer.png" &&
# MIGRATED $MWOFFLINER --mwUrl="https://en.wikipedia.org/" --customZimTitle="code7370" --customZimDescription="A broad but computing-focused subset of Wikipedia" --customMainPage="Computer_science" --customZimFavicon="$SCRIPT_DIR/computer.png" --articleList="$SCRIPT_DIR/selections/computer.lst" --outputDirectory=$ZIM/wikipedia/ &&
