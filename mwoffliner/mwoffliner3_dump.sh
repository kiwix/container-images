...
# MIGRATED $MWOFFLINER_MOBILE --mwUrl="https://it.wikipedia.org/" --parsoidUrl="https://it.wikipedia.org/api/rest_v1/page/html/" --customZimTitle="Wikimed Medical Encyclopedia" --customZimDescription="The Wikipedia Medical Encyclopedia" --customZimFavicon="$SCRIPT_DIR/medicine.png" --articleList="$SCRIPT_DIR/medicine" --outputDirectory=$ZIM/wikipedia/ &&
...
# MIGRATED $MWOFFLINER_MOBILE --customZimTitle="Wikivoyage - Europe" --articleList=europe --mwUrl="https://en.wikivoyage.org/" --parsoidUrl="https://en.wikivoyage.org/api/rest_v1/page/html/" --customMainPage="Wikivoyage:Offline_reader_Expedition/Europe_Home_page" --outputDirectory=$ZIM/wikivoyage/ &&
...
# MIGRATED $MWOFFLINER_MOBILE --mwUrl="https://en.wikipedia.org/" --articleList="ray_charles" --customZimTitle="Ray Charles" --customZimDescription="Wikipedia articles about Ray Charles" --customZimFavicon="ray_charles.png" --format= --format=novid --format=nopic --format=nodet --outputDirectory=$ZIM/wikipedia/ &&
...
# MIGRATED mwoffliner --withZimFullTextIndex --adminEmail=kelson@kiwix.org --mwUrl=https://fr.wikipedia.org/ --mobileLayout --format= --articleList=test.articles --verbose --customZimTitle=Test --customZimDescription="ZIM file for testing purpose" --customZimFavicon=320px-Test_art.png --outputDirectory=$ZIM/wikipedia/
